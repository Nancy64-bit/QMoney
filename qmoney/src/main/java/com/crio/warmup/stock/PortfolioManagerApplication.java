...
public class PortfolioManagerApplication {
  ...
  public static List<String> mainReadFile(String[] args) throws IOException, URISyntaxException {
    ...
    PortfolioTrade[] pfTrade = om.readValue(trades, PortfolioTrade[].class);
  ...
  //  2. In the same window, evaluate the value of expre ssion below and set it
  ...
  public static List<String> debugOutputs() {
     ...
     String resultOfResolveFilePathArgs0 = "/home/crio-user/workspace/chauhannandini234-ME_QMONEY_V2/qmoney/bin/main/trades.json";
